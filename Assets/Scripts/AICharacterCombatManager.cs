...
namespace MSA
{
    public class AICharacterCombatManager : CharacterCombatManeger
    {
        ...
        public void PivotTowardsTarget(AICharacterManager aiCharacter)
        {
            ...
            {
                aiCharacter.characterAnimatorManager.PlayTargetActionAnimation("Turn_Right", true);
            }
            else if (viewableAngle <= -20 && viewableAngle >= -60)
            {
                aiCharacter.characterAnimatorManager.PlayTargetActionAnimation("Turn_Left", true);
            }
